...
def analyze_with_chatgpt(code: str, context: dict, structure: str) -> dict:
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": "Malicious code includes: RAT, TROJAN, MINERS, SENDING INFORMATION TO UNKNOWN APIS, OBFUSCATED CODE, API KEY CONFIGURATIONS THAT ARE NOT MARKED AS OPTIONAL IN CONFIGURATION FILES, ETC."},
            {"role": "system", "content": "Do not search for vulnerabilities and risks of exposition in the code, but rather for threats related to using the code. Exposed private keys, variable names, and configuration files (.env, .conf, .json) SHOULD NOT be considered malicious code. Malicious code is code that is trying to scam, steal, or harm the user in any way."},
